...
class HFCRGasAPI:
    ...
    async def get_all_data(self) -> dict[str, Any]:
        ...
        # 计算近3个月汇总
        total_3m = round(sum(d.get("gasUsage", 0) for d in daily_3m), 2)
        avg_3m = round(total_3m / len(daily_3m), 2) if daily_3m else 0.0
